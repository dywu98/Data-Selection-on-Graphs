...
def load_data(traindir, valdir, args):
    ...
    if args.cache_dataset and os.path.exists(cache_path):
        ...
        def is_valid_file(path):
            ...
            if is_a_not_valid_flag:
                print(f"{path} is a not valid file")
                return False
            else:
                return True
...
def get_args_parser(add_help=True):
    ...
    # parser.add_argument("--prune-list", type=str, default="1015_test_wnode10_wedge02_p03_min10.txt", help="path to list of images to prune (one per line)")
    parser.add_argument("--prune-list", type=str, default=None, help="path to list of images to prune (one per line)")
